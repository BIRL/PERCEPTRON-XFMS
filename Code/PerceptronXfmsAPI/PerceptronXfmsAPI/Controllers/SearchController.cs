...
namespace PerceptronXfmsAPI.Controllers
{
    ...
    public class SearchController : ApiController
    {
        ...
        public string PerceptronXfmsInputFolder = @"F:\Input";
        ...
        [EnableCors(origins: "http://localhost:4200", headers: "*", methods: "post")]    //  https://perceptronxfms.lums.edu.pk/perceptronxfmsapi,
        [HttpPost]
        ...
        public async Task<HttpResponseMessage> File_upload()
        {
            ...
            try
            {
                ...
                Console.WriteLine("Before calling StoreXfmsSearchParameters");
                var response = _dataLayer.StoreXfmsSearchParameters(parametersDto);
                Console.WriteLine("After calling StoreXfmsSearchParameters");
